...
(nmds_station <- f_plotNMDS(order.nmdsplot, species.scores,  "Station", cols))
(nmds_WY <- f_plotNMDS(order.nmdsplot, species.scores, "fWY", cols, "Water Year")) 
(nmds_inundation <- f_plotNMDS(order.nmdsplot2, species.scores2,  "Inundation", cols, "Inundation") )
nmds_season1 <- f_plotNMDS(order.nmdsplot, species.scores, "Season1", cols)
(nmds_season3 <- f_plotNMDS(order.nmdsplot, species.scores, "Season3", cols2, "Season"))
