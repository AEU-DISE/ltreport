...
(nmds_WY <- f_plotNMDS(nmds150.org, all.flip150.org, "WY", cols, "Water Year"))
#plot of all 150 data with Season 2
(nmds_season1 <- f_plotNMDS(nmds150.org, all.flip150.org, "Season2", cols2, "Season")) 

#plot of STTD data only with inundation
(nmds_inundation <- f_plotNMDS(nmds150.STTD.org, all.flip150.STTD.org,  "Inundation", cols))
#plot of STTD data only with inundation
(nmds_season_STTD <- f_plotNMDS(nmds150.STTD.org, all.flip150.STTD.org, "Season2", cols2, "Season"))
...
tiff("WY2017_WY2019/figures/fig_drift_NMDS_All_Zoop_v2.tiff", res=300, width = 10, height = 8.5, units = "in",  family = "sans", compression = "lzw")
ggarrange(nmds_station, nmds_season1, nmds_season_STTD, nmds_inundation, ncol = 2, nrow = 2, labels = c("A", "B", "C", "D"))
dev.off()
```
