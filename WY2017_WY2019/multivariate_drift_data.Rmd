...
df.nmdsplot <- cbind(nmds.scores, speciesPredictorMatrix)
  ...
  annotate("text", x = min(df.nmdsplot$NMDS1) + 0.25, y = max(df.nmdsplot$NMDS2), label = paste('Stress = ', round(nmdsResult$stress,3))) + # Add stress to plot
...
tiff("WY2017_WY2019/figures/fig_drift_NMDS_All_Drift.tiff", res=300, width = 10, height = 8.5, units = "in",  family = "sans", compression = "lzw")
